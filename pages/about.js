...
const About = () => (
  <Layout>
    ...
    <div className="contained">
      ...
      <p>I work as a Software Engineer <a href="https://qlik.com">@Qlik</a>, and before that I worked as a web-developer in research at <a href="http://ohri.ca">The Ottawa Hospital</a>.</p>
